...
const createStore = () => {
  return new Vuex.Store({
    state: () => ({
      todos: [
        {content: 'テスト', created: '2022-05-19 23:00', state: '作業前'},
        {content: 'コーディング', created: '2022-05-19 23:10', state: '作業中'},
        {content: '環境構築', created: '2022-05-19 23:20', state: '完了'}
      ],
      option: [
        {id: 0, label: '作業前'},
        {id: 1, label: '作業中'},
